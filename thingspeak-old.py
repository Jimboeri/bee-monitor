...
class gatewayMessage:
  ...
  def DecodeTopic(self, inpTopic):
    ...
    if not self.config_found:
      print("Config not found, topic : {}".format(inpTopic))
...
def on_message(client, userdata, msg):
  ...
  print("Sub topic is {}".format(gMsg.subtopic))
  print("JSON message is {}".format(gMsg.jmsg))
  print(gMsg.field1_topic)
  print(gMsg.field2_topic)
  print(gMsg.field3_topic)
  print(gMsg.field4_topic)
